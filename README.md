This project implements a *Web-server* as a part of understanding Computer Networks courseware concepts. The code is intended to be clean albeit the name :)
